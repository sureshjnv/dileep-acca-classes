		...
		<div className="home">
			...
			>
				...
				<div
					style={{
						...
						flexWrap: 'nowrap',
						overflowX: 'auto',
						paddingLeft: '32px', // Add padding to left
						paddingRight: '32px', // Add padding to right
					}}
				>
					{bestCourses.map((course, idx) => (
						<div
							...
							style={{
								...
								marginLeft: idx === 0 ? '0' : undefined, // Remove margin for first
								marginRight:
									idx === bestCourses.length - 1 ? '0' : undefined, // Remove margin for last
							}}
							...
							{hovered === idx && (
								<div
									style={{
										...
										width: '100%',
										height: '100%',
										background: 'rgba(0,95,115,0.85)', // more transparent overlay
										color: '#fff',
										borderRadius: '16px',
										display: 'flex',
										...
										zIndex: 2,
										backdropFilter: 'blur(4px)', // glass effect for overlay
									}}
								>
									<h4
										style={{
			...
			>
				...
				>
					...
					>
						...
						{/* Repeat students for infinite scroll effect */}
						{[
							{
								name: 'Aarav Sharma',
								img: 'https://randomuser.me/api/portraits/men/32.jpg',
			...
			<section
				...
				style={{
					...
					maxWidth: '900px', // stretched horizontally
					textAlign: 'center',
					padding: '24px 0',
					borderRadius: '16px',
				...
				>
					...
					>
						<div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
							...
							/>
							<span style={{ color: '#25d366', fontWeight: 'bold', fontSize: '1rem' }}>WhatsApp</span>
						</div>
					</a>
					{/* YouTube */}
					<a
					...
					>
						<div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
							<img
								...
								onMouseOut={e => (e.currentTarget.style.transform = 'scale(1)')}
							/>
							<span style={{ color: '#ff0000', fontWeight: 'bold', fontSize: '1rem' }}>YouTube</span>
						</div>
					</a>
					{/* LinkedIn */}
					<a
					...
					>
						<div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
							<img
								...
								onMouseOut={e => (e.currentTarget.style.transform = 'scale(1)')}
							/>
							<span style={{ color: '#0077b5', fontWeight: 'bold', fontSize: '1rem' }}>LinkedIn</span>
						</div>
					</a>
				</div>
				<div style={{ fontSize: '1rem', color: '#333', opacity: 0.8 }}>
